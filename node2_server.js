...
const PORT = 3002;
const NODE_NAME = 'Node2';

// Load RSA keys
const nodePrivateKey = fs.readFileSync(path.join(__dirname, 'keys', 'node2_private.pem'), 'utf8');
const nodePublicKey = fs.readFileSync(path.join(__dirname, 'keys', 'node2_public.pem'), 'utf8');
...
const storageDir = path.join(__dirname, 'storage', 'node2');
